...
window.onload = function() {
    var settings = {
        ...
        upload_url: "<?php echo $this->createUrl('filem/upload'); ?>",
        ...
        button_text_style: ".theFont { font-family:Verdana, Geneva, sans-serif; font-size: 15px; text-align:center; font-weight:bold; color:#ffffff; }",
